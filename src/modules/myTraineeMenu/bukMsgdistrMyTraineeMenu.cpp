...
// Filename	    : bukMsgdistrMyTraineeMenu.cpp
// Description	:
// Ref Docs 	:
// Author	    : rohitm
...
CdModuleId traineeMid = getApplMidTrainee();				// Trainee Module ID
CdModuleId myTraineeMenuMid = getApplMidMyTraineeMenu();		// MyTraineeMenu Module ID (Self)
CdSuActorId nhMyTraineeMenuMid = getNhMidMyTraineeMenu();	// Network Handler Module ID (Self)
...
void* MyTraineeMenuMain::applicationStart (void* dummy1)
{
	CDSU_TRACE1 (4, "%s\n", __PRETTY_FUNCTION__);
	...
	//--------------------------------------------------------------------
	initParam.nhActorId = nhMyTraineeMenuMid;
	initParam.smActorId = myTraineeMenuMid;
	...
	addUdpPortReqParam.applActorId	= myTraineeMenuMid;
	addUdpPortReqParam.applEventHlr = applEventHlr;
	addUdpPortReqParam.localPortNo = localPortOfBothFixedMyTraineeMenu;
	addUdpPortReqParam.destPortNo = remotePortOfBothFixedMyTraineeMenu;
	...
	myTraineeMenuMain->msgDistr();

}// applicationStart1


void MyTraineeMenuMain::msgDistr()
{
	CdMessage* rxMsg;
	...
	while (1)
	{
		if(sentReq == 0)
		{
			BukMyTraineeMenuTrReq* sndMsg = (BukMyTraineeMenuTrReq *) cdSuGetMsgBuf (sizeof(BukMyTraineeMenuTrReq));
			sndMsg->initMsg(traineeMid, myTraineeMenuMid, reqId);
			CDSU_TRACE (1,"Request Msg Sending to Trainee...\n");
			if (cdSuMdSendMsg (sndMsg) == false)
			{
				CDSU_TRACE (1, "MyTraineeMenu: Error sending message\n");
				cdSuFreeMsgBuf (sndMsg);
			}else
			{
		...
		if (cdSuMdRecvMsg (&rxMsg, myTraineeMenuMid) == true)
		{
			CDSU_TRACE (5, "\nMessage received in MsgDistrMyTraineeMenu\n");
...
void MyTraineeMenuMain::msgFromTrainee(CdMessage* msg)
{
	CDSU_TRACE (5, "Response Msg from Trainee Arrived\n");
	BukMyTraineeMenuTrMsgs* rcvMsg = (BukMyTraineeMenuTrMsgs *)msg;
	int resId = rcvMsg->resId;
	myTraineeMenuObj.handleMsg(msg, TRAINEE, (void *)resId);

//	switch (msg->msgHdr.opcode)
//	{
//	case BUK_TR_MYTRAINEEMENU_RES:
//		{
//			CDSU_TRACE (5, "Response Msg from Trainee Arrived\n");
//			BukMyTraineeMenuTrMsgs* rcvMsg = (BukMyTraineeMenuTrMsgs *)msg;
//			int resId = rcvMsg->resId;
//			myTraineeMenuObj.handleMsg(msg, MYTRAINEEMENU, (void *)resId);
//		}
//		break;
//	default:
//			CDSU_TRACE (5, "Wrong Msg Opcode\n");
//		break;
//	}
...
void MyTraineeMenu::handleMsg(CdMessage *msg, int src, void* arg)
{
	if (src == TRAINEE)
	{
		switch (msg->msgHdr.opcode)
		...
		case BUK_TR_MYTRAINEEMENU_RES:
			{
			CDSU_TRACE (5, "Response Msg received from Trainee...\n");
			int resId = (long) arg; // rohitm
			CDSU_TRACE1 (5, "Response Id = %d\n", resId);
			} //case BUK_TR_MYTRAINEEMENU_RES
			break;
		default:
			CDSU_TRACE (5, "Wrong Msg Opcode\n");
...
//============================================================================
// End of bukMsgdistrMyTraineeMenu.cpp
//============================================================================
