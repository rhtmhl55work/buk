...
#define MAX_NO_CONN 10
#define MAX_SEND_DATA_ATTEMPT 1000
...
#ifdef __ECOS
char selfIpAddr[4] = { 192, 168, 50, 176 };
char remoteIpAddr [4] = {192, 168, 50, 176 };
#else
...
//----------------------------------------------------------------------------
// Parameter Selection Flag. Whether to select valid or invalid parameter.
//----------------------------------------------------------------------------
bool useValidNhInstId = true;		// Nh Inst flag.
bool useValidNhModId = true;		// Nh ModId flag.
bool useValidSmModId = true;		// SM ModId flag.
bool useValidApplModId = true;		// Appl ModId flag.

bool useMaxNoOfCon = true;		// Max Con flag.
bool useMaxNoOfLstn = true;		// Max Lstn flag.

bool useZeroLstnSelTimer = false;	// Lstn Sel Timer flag.
bool useZeroDataSelTimer = false;	// Data Sel Timer flag.
bool useZeroNoHlrTimer = false;		// No Handle Timer flag.

bool useValidLstnQSz = true;		 // Lstn Q sz flag. 
bool useValidDataPtr = true;		 // Data Ptr flag.
bool useZeroDataLen  = false;		 // Data Len flag.
bool useValidBufferLen 	= true;		 // Buffer Len flag.
...
char failCodeString  [] [100] =
{
	...
	"CDSU_NHTCP_FCODE_NO_LSTN",		// Listener doesn't exists. 
...
time_t endTime;
Uint32 timeGap;
Uint32 noOfSuccessConnReq = 0;
Uint32 noOfSuccessConnRsp = 0;
Uint32 noOfConnInd = 0;
Uint32 noOfSendDataReq = 0;
Uint32 noOfSendDataReqSuccess = 0;
Uint32 noOfSendDataRspSuccess = 0;
Uint32 noOfDataInd = 0;
//============================================================================
// <End of parameter.h>
//============================================================================
#endif
